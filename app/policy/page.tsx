									...
									<div className="flex items-center space-x-3 sm:space-x-4">
										...
										<div>
											<h1 className="text-2xl sm:text-3xl font-bold text-gray-900 flex items-center">
												<Shield className="w-6 h-6 sm:w-8 sm:h-8 mr-2 sm:mr-3 text-emerald-600" />
												Legal & Privacy
											</h1>
					...
					>
						<div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
							<Button
								...
								className={`w-full sm:w-auto px-4 sm:px-6 py-3 cursor-pointer text-sm sm:text-base ${
									activeTab === 'privacy'
			...
			<div className="space-y-6 sm:space-y-8">
				<section>
					<div className="flex items-center mb-3 sm:mb-4">
						<Lock className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 mr-2 flex-shrink-0" />
				...
				<section>
					<div className="flex items-center mb-3 sm:mb-4">
						<Globe className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 mr-2 flex-shrink-0" />
						<h3 className="text-lg sm:text-xl font-semibold text-gray-900">
				...
				<section>
					<div className="flex items-center mb-3 sm:mb-4">
						<Users className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 mr-2 flex-shrink-0" />
						<h3 className="text-lg sm:text-xl font-semibold text-gray-900">
							Information Sharing
						</h3>
					</div>
				...
				<section>
					<div className="flex items-center mb-3 sm:mb-4">
						<Eye className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 mr-2 flex-shrink-0" />
						<h3 className="text-lg sm:text-xl font-semibold text-gray-900">
							Your Rights
						</h3>
					</div>
